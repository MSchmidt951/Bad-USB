//This script opens a web link in a web browser
...
void setup(){
  ...
  if (digitalRead(switch1)) {
    ...
    typeStr("edge"); //Microsoft edge is installed on every windows 10+ device
    typeKey(KEY_RETURN);
    delay(2000);
    

    //Open link in a new tab
    doubleKey(KEY_LEFT_CTRL, 't');
    typeStr("https://www.youtube.com/watch?v=dQw4w9WgXcQ");
    typeKey(KEY_RETURN);
